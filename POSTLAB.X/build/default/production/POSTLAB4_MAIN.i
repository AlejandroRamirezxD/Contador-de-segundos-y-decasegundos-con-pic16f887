...
ORG 04h ; Posicion 0004h para las interrupciones
 ...
 isr:
    btfsc ((INTCON) and 07Fh), 0 ; Bandera del PORTB B
    call int_iocb ; Subrutina para incrementar el puerto A

    btfsc ((INTCON) and 07Fh), 2 ; Bandera del TMR0
 ...
 int_iocb:
    ...
    bcf ((INTCON) and 07Fh), 0 ; Borrar la bandera
...
main:
    call config_io ; Porta out, ((PORTB) and 07Fh), 7 y ((PORTB) and 07Fh), 0 como input
